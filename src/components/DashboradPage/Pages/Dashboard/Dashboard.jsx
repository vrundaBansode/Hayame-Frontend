                ...
                <div className='filter-card'>
                  <div className='filter'>
                    ...
                    <div className='filter-skills'>
                      <a href='/dashboard/dashboardform?skill=Labour' className='dashboard-a'><div className="filter-item" onClick={handleClick} id="labour">
                        <img src={labour} alt="labour" className='dashboard-img'/>
                        <p className='contractor-dashboard-p'>Labour</p>
                      </div></a>
                      <a href='/dashboard/dashboardform?skill=Hauler' className='dashboard-a'><div className="filter-item" onClick={handleClick} id="hauler">
                        <img src={hauler} alt="hauler" className='dashboard-img' />
                        <p className='contractor-dashboard-p'>Hauler</p>
                      </div></a>
                      <a href='/dashboard/dashboardform?skill=Pick-Pack' className='dashboard-a'><div className="filter-item" onClick={handleClick} id="pickpack">
                        <img src={pack} alt="pack" className='dashboard-img' />
                        <p className='contractor-dashboard-p'>Pick/Pack</p>
                      </div></a>
                      <a href='/dashboard/dashboardform?skill=Shipping' className='dashboard-a'><div className="filter-item" onClick={handleClick}>
                        <img src={shipping} alt="shipping" className='dashboard-img' />
                        <p className='contractor-dashboard-p'>Shipping</p>
                      </div></a>
                      <a href='/dashboard/dashboardform?skill=Lumper' className='dashboard-a'><div className="filter-item" onClick={handleClick}>
                        <img src={lumper} alt="lumper" className='dashboard-img' />
                        <p className='contractor-dashboard-p'>Lumper</p>
                      </div></a>
                      <a href='/dashboard/dashboardform?skill=Sanitation' className='dashboard-a'><div className="filter-item" onClick={handleClick}>
                  ...
                  <div className='filter'>
                    ...
                    <div className='filter-skills'>
                      <a href='/dashboard/dashboardform?skill=Dishwasher' className='dashboard-a'><div className="filter-item" onClick={handleClick}>
                        <img src={dishwasher} alt="dishwasher" className='dashboard-img' />
                        <p className='contractor-dashboard-p'>Dishwasher</p>
                      </div></a>
                      <a href='/dashboard/dashboardform?skill=Waiter' className='dashboard-a'><div className="filter-item" onClick={handleClick}>
                      ...
                      <a href='/dashboard/dashboardform?skill=Labour' className='dashboard-a'><div className="filter-item" onClick={handleClick}>
                        <img src={labour} alt="labour" className='dashboard-img' />
                        <p className='contractor-dashboard-p'>Labour</p>
                      </div></a>
                      <a href='/dashboard/dashboardform?skill=Set Up' className='dashboard-a'><div className="filter-item" onClick={handleClick}>
                        <img src={setup} alt="setup" className='dashboard-img' />
                        <p className='contractor-dashboard-p'>Set Up</p>
                      </div></a>
                      <a href='/dashboard/dashboardform?skill=Cook' className='dashboard-a'><div className="filter-item" onClick={handleClick}>
                  ...
                  <div className='filter'>
                    ...
                    <div className='filter-skills'>
                      <a href='/dashboardform?skill=Dishwasher' className='dashboard-a'><div className="filter-item" onClick={handleClick}>
                        <img src={dishwasher} alt="dishwasher" className='dashboard-img' />
                        <p className='contractor-dashboard-p'>Dishwasher</p>
                      </div></a>
                      <a href='/dashboard/dashboardform?skill=Food Service worker' className='dashboard-a'><div className="filter-item" onClick={handleClick}>
                      ...
                      <a href='/dashboard/dashboardform?skill=Bartender' className='dashboard-a'><div className="filter-item" onClick={handleClick}>
                  ...
                  <div className='filter'>
                    ...
                    <div className='filter-skills'>                    
                      ...
                      <a href='/dashboard/dashboardform?skill=Painter' className='dashboard-a'><div className="filter-item" onClick={handleClick}>
                        <img src={painter} alt="painter" className='dashboard-img' />
                        <p className='contractor-dashboard-p'>Painter</p>
                      </div></a>
                      <a href='/dashboard/dashboardform?skill=Construction Workers' className='dashboard-a'><div className="filter-item" onClick={handleClick}>
